...
public class Condiments_2258 extends Urun_2258 {
    public Condiments_2258(String adi, int kategoriIndex, String birimAgirligi, double birimFiyati, int stokMiktar, int katsayi, String kategoriAdi, String detay) {
